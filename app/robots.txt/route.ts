// Served at /perfect-dnd/robots.txt via basePath. Crawlers only read robots.txt
// from a host root, so blode.co/robots.txt governs the proxied path; this file is
// what perfect-dnd.blode.co resolves to, since that subdomain 308s to
// blode.co/perfect-dnd and both Google and Search Console follow the redirect.
//
