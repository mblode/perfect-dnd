 ...
 * Modelling it as separate `activeBlockId` / `settlingBlockId` / rect /
 * rotation / scale fields let illegal pairs exist, and left the transitions
 * split across two components that raced each other on drag cancel.
 */
