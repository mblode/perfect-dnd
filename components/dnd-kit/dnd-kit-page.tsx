...
export const EditorPage = observer(() => {
  ...
  // Reordering only. The card keeps flying until the settle finishes, so the
  ...
  const handleSettled = useCallback(() => store.endDrag(), [store]);
   ...
   */
  const handleDragCancel = useCallback(() => store.endDrag(), [store]);
